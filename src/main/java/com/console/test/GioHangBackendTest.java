...
public class GioHangBackendTest {
    ...
    public static void main(String[] args) {
        ...
        // int listCheckSPHetHang =
        // gioHangMapper.checkSPHetHang(maKhachHang,maSanPham,soLuongGH);
        ...
        // gioHangMapper.getSellerList(maKhachHang);
        // Gson gson = new Gson();

        // // System.out.println("------------Danh sách sản phẩm chia theo id người
        // bán--------");
        ...
        // if
        // (gioHangMapper.deleteSP(maKhachHang,"35a99f29-64da-11ec-bb14-8378cfa7d63d")
        // == 0) {
