...
public class RegularExpression {
  static final String PASSWORD_REGEX = "^[A-Z]{1}[A-Za-z0-9]{7,29}$";  public static void main(String[] args) {
      ...
      System.out.println("Password kí tự đầu là in hoa, các kí tự sau là chữ hoặc số, không có kí tự đặc biệt, độ dài từ 8 đến 30 kí tự");
