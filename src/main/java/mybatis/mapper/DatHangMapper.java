...
public interface DatHangMapper {
        ...
        /*
         * Có lỗi chỗ tổng tiền, thì catch là chạy câu lệnh in ra sản phẩm mình muốn đặt mua
         * mà không đủ số lượng
         * 
         * Cần thông báo số lượng còn cho những sản phẩm mà khách hàng đặt lố trong giỏ hàng
         * Cần ô tham mưu chỗ này, tui phân vân có nên làm lệnh này để chặn ở chỗ thêm giỏ hàng không
         */
